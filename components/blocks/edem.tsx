...
export const Edem = ({ data, parentField }) => {
    ...
    return (
      <Section>
        <div className="relative py-24 flex flex-col justify-center items-center text-center text-white opacity-85" style={{background: "#121212"}}>
            <p className="my-4 font-bold text-2xl">Наш партнёр</p>
            <p className="font-bold text-4xl">Учебный центр "ЭДЕМ"</p>
...
с последующим <b>трудоустройством</b></p>
            ...
            <a className="mt-6" href={data.edemLink}>
                <Button label="Подробнее" style={{background: "#ea6c45", border: 0}} />
            </a>
        </div>
      </Section>
    );
