	...
	return (
		<Section color={data.color} data-tinafield={`${parentField}.body`}>
            ...
            <div className="my-12 flex flex-col items-center md:justify-center md:flex-row">
            	...
            	<img className="h-1/2 rounded-md shadow-xl md:mx-12 md:w-1/3 " src={data.aboutItemFirst.image ? data.aboutItemFirst.image.src: ""} aria-hidden="true" alt="firstItem"/>
            </div>
				}
				{!data.aboutItemSecond || 
            <div className="my-12 flex flex-col-reverse items-center md:justify-center md:flex-row">
            	<img className="h-1/2 rounded-md shadow-xl md:mx-12 md:w-1/3" src={data.aboutItemSecond.image ? data.aboutItemSecond.image.src:""} aria-hidden="true" alt="secondItem"/>
            	<div className="mx-6">
            ...
            <div className="my-6 flex flex-col justify-center items-center">
            	...
            	<img src={data.aboutSert.image ? data.aboutSert.image.src: ""} aria-hidden="true" alt="certificate"/>
            </div>
				}   
				{!data.link || 
