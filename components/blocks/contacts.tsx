            	...
            	<div className="flex flex-wrap justify-center">
            		<div className="mx-2 flex flex-wrap justify-center items-center md:mx-6">
            			{data ? data.contact.map((item) => {
            				return (
            					<div key={item.header} className="m-2 my-4 p-4 flex flex-col justify-center items-center bg-white shadow-md md:m-4 md:p-8">
            						...
            						<div className="my-2 flex flex-col items-center">
            							...
            							{item.phones ? item.phones.map((p) => {
            								return (
            									<a key={p.phone} className="text-orange-500 text-bold underline font-bold text-center" href={p.phone}>{p.phone}</a>
            								);
            							}):[]}
            						</div>
            						<div className="my-2 flex flex-col items-center">
            							...
            							{item.emails ? item.emails.map((e) => {
            								return (
            									<a key={e.email} className="text-orange-500 text-bold underline font-bold" href={e.email}>{e.email}</a>
            								);
            							}):[]}
            						</div>
            					</div>
            		...
            		<div>
            			<div className="mt-8">
            				...
            				<div className="flex flex-col items-center">
            					<div className="my-2">
            						<a href="https://vk.com/armstospb" className="flex items-center font-bold text-blue-600 transition hover:opacity-60">
            					...
            					<div className="my-2">
            						<a href="https://instagram.com/armsto.spb" className="flex items-center font-bold text-pink-600 transition hover:opacity-60">
            							<img src="/arm_instagram.svg" alt="" />
            							<span className="ml-2">Instagram</span>
            						</a>
            					</div>
            					<div className="my-2">
            						<a href="https://api.whatsapp.com/send/?phone=79313996757&text&app_absent=0" className="flex items-center font-bold text-green-600 transition hover:opacity-60">
